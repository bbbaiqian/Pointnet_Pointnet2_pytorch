...
def parse_args():
    ...
    parser.add_argument('--log_dir', type=str, default='pointnet2_sem_seg_pascal', help='Experiment root')
...
def main(args):
    ...
    TEST_DATASET_WHOLE_SCENE = ScannetDatasetWholeScene(root, split='test', test_area=args.test_area, block_points=NUM_POINT, num_class=NUM_CLASSES)
